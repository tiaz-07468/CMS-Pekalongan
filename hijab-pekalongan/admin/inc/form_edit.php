...
<div>
        ...
        <div>
            ...
            <div class="col-md-9">
                <input type="text" name="judul" class="form-control" value="<?php echo $data['judul']; ?>" id="firstname" placeholder="Masukkan judul berita">
                <input type="hidden" name="id_berita" class="form-control" value="<?php echo $data['id_berita']; ?>" id="firstname" placeholder="Masukkan judul berita">
            </div>
            <div class="col-md-1">
