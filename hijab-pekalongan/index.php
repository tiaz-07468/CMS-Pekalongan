	...
	<body data-spy="scroll">
			...
			<ul class="cb-slideshow">
				<li><span>image1</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>Hijab Community Pekalongan</h3>
								<h1>Bring back woman fitrah in islam</h1>
								</div>
							</div>
						</div>
				...
				<li><span>image2</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>Hijab Community Pekalongan</h3></div>
							</div>
						</div>
						<h4>Patience is Beautiful</h4>
					</div>
				</li>
				<li><span>image3</span>
					<div class="container">
					...
					<div class="col-md-offset-1 col-md-10">
						<div class="text-center">
							...
							<div class="row">
								<div class="col-md-12">
									<p>
									Hijab Community Pekalongan hadir dengan visi dan misi syiar Islam melalui hijab. Komunitas ini tampil berbeda untuk menampilkan keindahan. Baik itu keindahan dalam berhijab juga keindahan dalam menjalani kehidupan sebagai muslimah yang sesuai dengan perintahNYA.</p>

									<p>Visi :
									Sebagai sarana berkumpulnya muslimah-muslimah di Pekalongan dan sekitarnya untuk saling bertukar wawasan, untuk meningkatkan rasa solidaritas dan ketaqwaan kepada Allah SWT.<p>

									<p>Misi :

									Mempererat tali silaturahmi dan memperoleh ilmu-ilmu positif dalam sharing. Mengenalkan hijab sesuai dengan syariat islam. Memperdalam ilmu agama dengan kebersamaan.
									</p>
								</div>
							</div>
						</div>
		...
		<section id="services">
			<div class="orangeback">
				<div class="container">
					<div class="text-center homeport2"><h2>Kegiatan</h2></div>
					<div class="row">
						<div class="col-md-12 homeservices1">
							<div class="col-md-3 portfolio-item">
								<div class="text-center">
									...
									<h3><a href="#">Ilmu</a></h3>
									<p>Sharing ilmu dengan teman dari berbagai daerah.</p>
								</div>
							</div>
							<div class="col-md-3 portfolio-item">
								<div class="text-center">
									...
									<h3><a href="#">Sillaturrahmi</a></h3>
									<p>Menjaga tali silaturrahmi antar umat muslim dengan saling bertukar kisah dan sapa.</p>
								</div>
							</div>
							<div class="col-md-3 portfolio-item">
								<div class="text-center">
									...
									<h3><a href="#">Pengajian</a></h3>
									<p>Menambah pahala dan memperbaiki bacaan Qur'an bersama sama dengan ahlinya</p>
								</div>
							</div>
							<div class="col-md-3 portfolio-item">
								<div class="text-center">
									...
									<h3><a href="#">Berbagi Kasih</a></h3>
									<p>Berbagi kasih dengan orang orang di sekitar kita</p>
								</div>
							</div>
						</div>
					</div>
		...
		<section id="bloghome">
			<div class="container">
				<div class="text-center"><h2>Berita Kami</h2>
					...
					?>
						<div class="col-md-4 col-sm-12 col-xs-12 portfolio-item">
							<figure class="effect-oscar">
								<img src="images/berita/<?php echo $data['foto']; ?>" alt="" class="img-responsive" height="426" width="620"/>
								<figcaption>
							...
							<div class="text-center">
							<a class="btn btn-primary btn-noborder-radius hvr-bounce-to-bottom" target="_blank" href="post.php?id_berita=<?php echo $data['id_berita']; ?>">Baca Selengkapnya</a></div>
						</div>
						<?php } ?>
						</div>
					</div>
				...
				<div class="row teamspace">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							...
							<p>Hijabers asal Pekalongan yang pintar</p>
						</div>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
 ...
 -->
		...
		<div class="row">
			...
			<ul class="filter nav nav-pills">
			  <li data-value="all" ><a class="active" href="#">Hijab Community Pekalongan</a></li>
			  <!-- <li data-value="ngaji"><a href="#">Pengajian</a></li>
			  <li data-value="kasih"><a href="#">Berbagi Kasih</a></li>
			  <li data-value="foto"><a href="#">Fotografi</a></li> -->
			</ul>
			...
			<ul class="port2">
				...
				<?php
						...
						foreach ($res as $data) {
				?>	
			  <li data-type="<?php echo $data['jns_gambar']; ?>" data-id="id-1" class="port3">
				<a href="#" id="development1"><img src="images/<?php echo $data['lokasi']; ?>" alt="" height="340" width="220"></a>
			  </li>
			  <?php } ?>
			...
			if (goodToGo) {
			   $.ajax({
				 ...
				 success:function(response){
				   if (response==1) {
					 $('#success').html('<div class="col-md-12 text-center">Email telah berhasil dikirim</div>');
					 window.location.reload();
				   } else {
					 $('#success').html('<div class="col-md-12 text-center">Email gagal dikirim. Silahkan coba lagi!</div>');
				   }
				 },
				 error:function(e){
