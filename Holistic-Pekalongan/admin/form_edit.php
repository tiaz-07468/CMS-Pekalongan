<?php
	...
	$data = $con->selectProduk($_GET['kunci']);
?>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <form action="libs/proses_edit.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <center><h3>Edit Produk</h3></center>
                            <label for="caption">Nama Produk</label>
	                            <input type="text" class="form-control" name="nama_produk" id="nama" placeholder="nama" value="<?php echo $data['nama_produk']; ?> ">
	                            <input type="hidden" class="form-control" name="id" id="nama" placeholder="nama" value="<?php echo $data['id']; ?> ">
                            <label for="caption">Keterangan Produk</label>
                            	<input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="keterangan" value="<?php echo $data['keterangan']; ?>">
                        <div class="form-group">
                    ...
                    <table class='table table-striped'>
                        ...
                        foreach ($res as $data) {
                            ...
                            <tr>
                                ...
                                <td><a href="libs/proses_hapus_produk.php?kunci=<?php echo $data['id']; ?>">[Hapus]</td>
                            </tr>
