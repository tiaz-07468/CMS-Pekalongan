    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="selected"><a href="portfolio.php"><i class="fa fa-tasks"></i> Upload Foto</a></li>
                ...
                <div class="col-md-8">
                    <form action="upload.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <center><h3>Upload Foto</h3></center>
        ...
        <?php include_once "libs/function.php"; ?>
            <div>
                ...
                <div class='col-md-6'>
                    <center><h3>Daftar Foto</h3></center>
                    <table class='table table-striped'>
                        ...
                        foreach ($res as $data) {
                            ?>
                            <tr>
                                <td><img class="img-responsive" src="<?php echo $data['lokasi'] ?>" height="100" width="100"></td>
                                <td><?php echo $data['nama_foto'] ?></td>
                                <td><a href="libs/proses_hapus_galeri.php?kunci=<?php echo $data['id']; ?>">[Hapus]</td>
                            </tr>
